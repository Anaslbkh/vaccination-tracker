<template>
  <div class="country">
    ...
    <select name="countries" v-model="country" id="">
      <option selected hidden disabled value="choose coutry">
        choose country
      </option>
      <option
    ...
    <button @click="showdata()">Search</button>
